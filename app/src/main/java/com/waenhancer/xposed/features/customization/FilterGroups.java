...
public class FilterGroups extends Feature {
    ...
    private void setSetupSeparate(ViewGroup view) {
        ...
        borderDrawable.setStroke(Utils.dipToPixels(2), DesignUtils.getUnSeenColor());
    ...
    private void setDrawableSelected(View view, int colorBackground, int colorStroke, int left) {
        ...
        GradientDrawable borderDrawable = new GradientDrawable();
        borderDrawable.setColor(Color.TRANSPARENT);
        borderDrawable.setStroke(Utils.dipToPixels(2), colorStroke);
        borderDrawable.setCornerRadii(rects);

        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{borderDrawable, shape});
        layerDrawable.setLayerInset(1, Utils.dipToPixels(2), Utils.dipToPixels(2), Utils.dipToPixels(2), Utils.dipToPixels(2));
