    ...
    public void doHook() throws Exception {
        ...
        XposedBridge.hookAllMethods(Activity.class, "onPrepareOptionsMenu", new XC_MethodHook() {
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                var menuItem = menu.add(0, 10001, 0, FeatureLoader.getModuleString(Utils.getApplication(), com.waenhancer.R.string.force_restore_backup_experimental));
                Activity activity = (Activity) param.thisObject;
                menuItem.setOnMenuItemClickListener((item) -> {
                    new AlertDialogWpp(activity)
                            .setTitle(R.string.force_restore_backup)
                            .setMessage(FeatureLoader.getModuleString(activity, R.string.warning_restore))
                            .setPositiveButton(FeatureLoader.getModuleString(activity, R.string.yes), (dialog, which) -> {
                                try {
                            ...
                            .setNegativeButton(FeatureLoader.getModuleString(activity, R.string.no), null)
                            .show();
